...
- The workbench is source-neutral. Text and bytes are independent capabilities. The separate file-manager plugin owns authenticated filesystem access, external-opening policy, routing and its launcher.
