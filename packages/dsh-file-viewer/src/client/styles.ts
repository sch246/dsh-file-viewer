...
.dsh-resource-file-size{white-space:nowrap;color:var(--dsw-alias-label-secondary);font-size:11px}
...
.dsh-file-viewer-editor-settings{max-height:calc(100vh - 220px);overflow:auto;padding:4px 8px;border:1px solid var(--dsw-alias-border-l2);border-radius:6px;background:var(--dsw-alias-bg-layer-2)}
...
.dsh-file-viewer-editor-settings input{width:150px}.dsh-file-viewer-editor-settings input[type=number]{width:64px}.dsh-file-viewer-editor-settings p{max-width:260px;white-space:normal;overflow-wrap:anywhere}.dsh-file-viewer-editor-settings>button{margin-top:5px}
...
.dsh-file-viewer-failure,.dsh-file-viewer-state[role=alert]{color:var(--dsw-alias-state-error-primary)}
.dsh-file-viewer-failure-detail{display:block;margin-top:2px;overflow-wrap:anywhere}
