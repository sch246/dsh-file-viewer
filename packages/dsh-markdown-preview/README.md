...
Use Edit side by side to open the text editor to the left of this preview. Both consume the same document. Reload from file observes disk state; it is not required to see local typing.
